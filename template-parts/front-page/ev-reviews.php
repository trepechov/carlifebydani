...
?><div class="bg-pattern">
    <div class="container py-6">
        <div class="flex mb-8 justify-between items-center">
            <h3 class="border-l-8 p-3 border-brand-red uppercase">EV Reviews</h3>
        ...
        <div class="mb-8 lg:grid lg:grid-cols-4 lg:gap-8 lg:place-items-stretch">
            ...
            for ($i = 0; $i < 8; $i++) {
                ...
                get_template_part('template-parts/card-article', 'article',  array('post' => $ev_reviews_posts[$i], 'title_size' => 'small'));
            }
            ?>
        </div>
    </div>
