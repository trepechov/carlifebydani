<article class="p-5 bg-black flex items-start gap-5 rounded-br-2xl js-external-article">
    ...
    <div class="flex flex-col justify-between flex-1">
        <div class="peer min-h-[80px] flex flex-col justify-between">
            <h5 class="mt-0">
                <a href="<?php echo esc_url($args['article']->link) ?>" target="_blank" rel="nofollow" class="hover:text-brand-red link-transition"><?php echo esc_html($args['article']->title) ?></a>
            </h5>
